...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('add_post', '0004_remove_apartmentunit_company_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='add_post.apartmentbuilding')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amenity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='add_post.amenities')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apartment_building', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='add_post.apartmentbuilding')),
            ],
            options={
